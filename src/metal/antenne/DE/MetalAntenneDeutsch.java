...
public class MetalAntenneDeutsch {
	...
	// einfaches MP3 music player mit javafx/swing Komponenten
	// javafx-sdk-19, jdk-17.0.2 wird benötigt um das Programm starten zu können
	// alleinstehende und ausführbare *.exe Datei kann mit Hilfe Launch4j erstellt
	// werden
	// bitte nicht vergessen die VM arguments: --module-path
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					MetalAntenneDeutsch window = new MetalAntenneDeutsch();
	...
	private void initialize() {
		...
		frmAntenne.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				...
				ImageIcon icon = new ImageIcon(Toolkit.getDefaultToolkit()
						.getImage(MetalAntenneDeutsch.class.getResource("Simpsons-Garage-band-homer.jpg")));
				Object[] options = new Object[] { "Ja, ich muss jetzt gehen", "Nein, ich bleibe noch" };

				if (JOptionPane.showOptionDialog(frmAntenne, "Möchtest du mich wirklich verlassen mit der guten Musik?",
						"Ende?", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, icon, options,
		...
		frmAntenne.setIconImage(
				Toolkit.getDefaultToolkit().getImage(MetalAntenneDeutsch.class.getResource("electric-guitar.png")));
		...
		JButton btnPlay = new JButton("Abspielen");
		btnPlay.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!songs.isEmpty()) {
					...
					JOptionPane.showMessageDialog(frmAntenne, "Es wurde noch keine Musikdatei geladen!", "Achtung",
		...
		JButton btnNext = new JButton("Nächste");
		...
		JButton btnPrevious = new JButton("Vorherige");
		...
		lblBackGround.setIcon(new ImageIcon(
				Toolkit.getDefaultToolkit().getImage(MetalAntenneDeutsch.class.getResource("gitar-bolt-990x556.jpg"))));
		...
		JMenu mnMusic = new JMenu("Musik laden");
		...
		JMenuItem mtmLoadMusicFromFiles = new JMenuItem("Musikdatei(en) laden");
		...
		JMenuItem mtmLoadMusicFromDirectory = new JMenuItem("Kompletten Musikordner laden");
	...
	private void LoadMusicFromDirectory() {
		...
		chooser.setDialogTitle("Musikordner suchen");
		chooser.setApproveButtonText("Musik laden");
	...
	private void LoadMusicFromFiles() {
		...
		JFileChooser chooser = new JFileChooser();
		chooser.setDialogTitle("Musikdatei(en) suchen");
		chooser.setApproveButtonText("Musik laden");
		chooser.setMultiSelectionEnabled(true);

		FileNameExtensionFilter filter = new FileNameExtensionFilter("Musikdateien", "mp3");
